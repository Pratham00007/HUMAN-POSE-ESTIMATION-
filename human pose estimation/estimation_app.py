...
# if image is not uploded yet use demo image for sample
else:
...
# for more accurate point detection
...
def poseDetector(frame):
    ...
    for i in range(len(BODY_PARTS)):
        # this will Slice heatmap of corresponging body part.
        heatMap = out[0, i, :, :]
...
# it will be written below output image after pose detection
st.image(
